export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#010313] via-[#051F40] to-[#0A3064] text-white">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                <div className="w-10 h-10 bg-[#051F40] rounded-full flex items-center justify-center group-hover:bg-[#EF7D02] transition-colors duration-200">
        ...
        {/* Bottom Section */}
        <div className="mt-8 pt-8 border-t border-[#DcB798]/30">
